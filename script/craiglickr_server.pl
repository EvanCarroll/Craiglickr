...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{CRAIGLICKR_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{CRAIGLICKR_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
craiglickr_server.pl - Catalyst Testserver

=head1 SYNOPSIS

craiglickr_server.pl [options]
